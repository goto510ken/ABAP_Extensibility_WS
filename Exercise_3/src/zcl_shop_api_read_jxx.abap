CLASS zcl_shop_api_read_jxx DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_JXX IMPLEMENTATION.
  ...
  METHOD if_http_service_extension~handle_request.
    ...
    DATA:
      ls_entity_key    TYPE zonline_shop6eb174ae3d,
      ls_business_data TYPE zonline_shop6eb174ae3d,
...
*                                             comm_system_id = '<Comm System Id>'
        ...
        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_JXX'
...
*                                        proxy_model_id      = 'Z_SHOP_API_SCM_JXX'
...
*    iv_relative_service_root   = '<service_root>' ).
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'DD5F294E1FD01EDDBC9171F45C1787B6' ).
